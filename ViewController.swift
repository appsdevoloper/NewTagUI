...
class ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        // MARK: Validate Values Already Exsist or Not
        ...
        if UserDefaults.standard.object(forKey: "b") as? [String:Any] == nil {
            let tag = TagModel(tagId: 1, tagName: "Jackma", tagStoreKey: "b")
            tag.save()
            self.items.append(tag)
            print("Select B Value")
        }
        
        if UserDefaults.standard.object(forKey: "c") as? [String:Any] == nil {
            let tag = TagModel(tagId: 2, tagName: "Team", tagStoreKey: "c")
            tag.save()
            self.items.append(tag)
